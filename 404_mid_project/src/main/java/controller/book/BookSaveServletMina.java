...
@WebServlet("/booking/submitMina")
public class BookSaveServletMina extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	    ...
	    if (stayNumStr != null && !stayNumStr.isEmpty()) {
	        ...
	        // 숙소 정보 가져오기
	        StayDto stay = StayDao.getInstance().getBy(stayNum);
	    ...
	    req.getRequestDispatcher("/booking/booking-page-mina.jsp").forward(req, res);
	}
